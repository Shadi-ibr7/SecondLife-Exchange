...
const nextConfig = {
  ...
  env: {
    ...
    // NOTE: NEXT_PUBLIC_CLOUDINARY_API_KEY a été retiré pour sécurité renforcée
    // L'api_key est maintenant fournie dans la signature backend (pas de secret exposé)
