 ...
 * Usage: tsx scripts/apply-actor-role-migration.ts
 */
...
async function applyMigration() {
  ...
  try {
    ...
    await prisma.$executeRaw`
      ALTER TABLE IF NOT EXISTS admin_logs
    ...
    `;
    console.log(`✅ ${updateResult} logs existants mis à jour avec ADMIN`);
